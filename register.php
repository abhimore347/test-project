...
if (isset($_GET ['registration_error']) && $_GET['registration_error']==1) {
  echo "<script>alert('user exist')</script>";
}
else if (isset($_GET ['success_msg']) && $_GET['success_msg']==2) {
  echo "<script>alert('user register successfully')</script>";
}

  ?>
              <form class="user" action="registeration_check.php" method="post">
                ...
                <button type="submit"  value="register" class="btn btn-primary btn-user btn-block">
                Register Account
                </button>
                <!-- <hr>
              ...
              <div class="text-center">
                <a class="small" href="login.php">Existing user? click here to login</a>
              </div>
            </div>
          </div>
        </div>
